<div class="my-container text-center">
    <x-sub-heading subTitle='Pesan Rental Mobil Terdekat Sekarang'
        description='Anda bisa pesan rental secara online melalui whatsapp.' />

    <x-contact.booking-steps />
    ...
    <div class="">
        <iframe loading="lazy" title="alamat" src={{ address()->iframe }} allowFullScreen="true"
